...
@Component({
  selector: 'app-additemwithai',
  templateUrl: './additemwithai.component.html',
  styleUrls: ['./additemwithai.component.scss'],
})
export class AddItemWithAIComponent implements OnInit {
  constructor(
  ...
  viewFile(ondcId){
    this.router.navigate(['/client/inventory/items/ai', ondcId]);
  }
  clearingFiles() {
